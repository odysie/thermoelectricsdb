...
from .quantity_default import magnitudes_dict, value_element, extract_units, value_element_plain, lbrct, rbrct
...
class AutoSentenceParser_Old(BaseAutoParser, BaseSentenceParser):

    def __init__(self, lenient=False, chem_name=(cem | chemical_label | lenient_chemical_label)):
        super(AutoSentenceParser_Old, self).__init__()
