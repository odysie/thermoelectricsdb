from chemdataextractor.parse import Optional, R, T, W
...
editing_expression =  (editing_follows | editing_leads | standalone_edit | in_place_of).add_action(join)  # is the optional joining word too permissive? should it be mandatory?