...
units_dict = {R('((A(mpere(s)?)?)|(ampere(s)?))', group=0): Ampere} #oddy: this was probably the problem, leading to things like and, any, at to be considered as units. It had a as a possible unit.
